...
\begin{table}[hbpb]
	...
	\begin{tabular}{cclc}
		...
		\bottomrule
	\end{tabular}
	\caption{\textit{Mosse di un parser predittivo durante l'analisi della stringa \textbf{cdd}} }
\end{table}\\
...
\begin{align}
	I \Rightarrow A \Rightarrow S \Rightarrow CC \Rightarrow cCC \Rightarrow \Rightarrow cdC \Rightarrow cdC \Rightarrow cdd
\end{align}
...
\section{Conclusioni}
In questo capitolo è stato discusso di come funziona il parsing top down ed in particolare si è discusso del parsing LL(1). Questo parser, però, presenta dei limiti:
\begin{itemize}
